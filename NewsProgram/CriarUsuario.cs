...
namespace NewsProgram
{
    ...
    { // CONEXÃO COM O BANCO DE DADOS
        SqlConnection conn = new SqlConnection(@"workstation id=workstation id=DiegoSouza.mssql.somee.com;packet size=4096;user id=diegosmelo_SQLLogin_1;pwd=ctkqvjpeof;data source=DiegoSouza.mssql.somee.com;persist security info=False;initial catalog=DiegoSouza");
